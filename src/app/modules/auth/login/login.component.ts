    ...
    <div class="auth-container">
      <div class="auth-card">
        ...
        <div class="segment-switcher">
          <button class="switcher-btn active">Sign In</button>
          <button class="switcher-btn" routerLink="/auth/register">Sign Up</button>
        </div>
        ...
        <p class="auth-footer-link">
          ...
          <a class="highlight-link" routerLink="/auth/register">Sign Up</a>
        </p>
